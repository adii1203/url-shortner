...
import placeHolderImg from "../../assets/nolink.svg";
      ...
      <div className="h-full">
        <div className=" w-full pb-16">
          <div className="w-full  bg-[#111] ">
            <div className="flex items-center justify-between h-24  w-full md:w-[40rem] lg:w-[60rem] mx-auto px-8">
              <div className="font-Outfit capitalize">
                <h1 className="text-[#eee] text-4xl font-semibold">links</h1>
                <p className="text-[#eee] text-sm ">{`total- ${data.length}`}</p>
              </div>
              <Button
                onClick={() => setShowCreateEditModel(!showCreateEditModel)}
                varient="primary"
                className={
                  "bg-[#eee] text-[#1a1a1a] w-40 py-2 justify-center font-bold hover:bg-transparent hover:text-[#eee] hover:border-[#eee] border"
                }>
                Create Link
              </Button>
              <CreatEditLinkModelCallback />
          ...
          <div className="">
            {data.length === 0 ? (
              ...
              data?.map((link) => {
                return (
                  <div key={link._id} className="px-2">
                    <LinkCard link={link} />
                  </div>
                );
              })
            )}
            <div className="h-14 w-full bg-[#111] fixed bottom-0"></div>
          </div>
        </div>
      </div>
    </>
...
const NoLinks = () => {
  return (
    <svg
      className="mx-auto bg-[#444] mt-4 rounded-md"
      width="460"
      height="460"
      viewBox="0 0 960 960"
      fill="none"
      xmlns="http://www.w3.org/2000/svg">
      <g clipPath="url(#clip0_317_818)">
        <path
        ...
        <path
          ...
          fill="url(#paint0_linear_317_818)"
        />
        <path
        ...
        <path
          ...
          fill="url(#paint1_linear_317_818)"
        />
        <path
          ...
          fill="url(#paint2_linear_317_818)"
        />
        <path
        ...
        />
        <path
          d="M89.6736 595.462L80.9736 584.589"
          stroke="#171717"
          strokeWidth="3.081"
          strokeLinecap="round"
          strokeLinejoin="round"
        />
        <path
          d="M77.7119 595.462L87.4979 585.676"
          stroke="#171717"
          strokeWidth="3.081"
          strokeLinecap="round"
          strokeLinejoin="round"
        />
        <path
          d="M90.7606 659.614L82.0605 653.09"
          stroke="#171717"
          strokeWidth="3.081"
          strokeLinecap="round"
          strokeLinejoin="round"
        />
        <path
          d="M80.9746 660.7L87.4986 650.914"
          stroke="#171717"
          strokeWidth="3.081"
          strokeLinecap="round"
          strokeLinejoin="round"
